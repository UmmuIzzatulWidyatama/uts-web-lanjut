...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url('about_me'); ?>">About Me</a></li>
...
<section>
    ...
    <center>
        <table border=" 1" width =100% >
            <tr>
                <td style="text-align: center; font-weight: bold;">Tingkat</td>
                <td style="text-align: center; font-weight: bold;">Nama Sekolah</td>
            </tr>
            <tr>
                <td>TK</td>
                <td>TK Al Hidayah</td>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <p>&copy; <?= date('Y') ?> Ummu Izzatul K</p>
